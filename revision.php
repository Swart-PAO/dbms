                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="land-tab">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <table id="revision-land-table" class="table table-hover align-middle mb-0" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>PIN</th>
                    ...
                    <div class="tab-pane fade" id="building-tab">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <table id="revision-building-table" class="table table-hover align-middle mb-0" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>PIN</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $results = getBuildingByBarangayRevision($mun_code, $brgy_session, NULL, NULL);
                                        $counter = 1;
                                        while ($row = $results->fetch_assoc()):
                                        ?>
                                            <tr>
...
<script>
    ...
    $(document).on("click", ".barangay-folder", function() {
        ...
        loadRevisionLand(mun, brgy);
        loadRevisionBuilding(mun, brgy);

    });

    function loadRevisionLand(mun_code, barangay) {

        $.post("municipal/load_revision_land.php", {
            mun_code: mun_code,
            barangay: barangay
        }, function(html) {
            $("#revision-land-table tbody").html(html);

        });
    }

    function loadRevisionBuilding(mun_code, barangay) {

        $.post("municipal/load_revision_building.php", {
            mun_code: mun_code,
            barangay: barangay
        }, function(html) {
            $("#revision-building-table tbody").html(html);
