...
<body>
    ...
    $sqlPie = "SELECT m.mun_name, COUNT(*) AS total
           FROM property_info f
           JOIN municipality_list m 
    ...
    $UserInfo = "SELECT property_info.recording_person_id, user.name, user.department FROM property_info JOIN user ON property_info.recording_person_id = user.user_ID WHERE property_info.recording_person_id = $user_id LIMIT 1";
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <?php
                                $totalSql = "SELECT COUNT(*) AS total FROM property_info WHERE recording_person_id = '$user_id'";
                                $totalRes = $conn->query($totalSql);
                                $totalData = $totalRes->fetch_assoc();
                                ?>

                                <?php
                                $todaySql = "SELECT COUNT(*) AS today FROM property_info WHERE recording_person_id = '$user_id' AND DATE(recording_date) = CURDATE()";
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover mb-0">
                                        ...
                                        <tbody class="table-group-divider small">
                                            <?php
                                            $Transactions = "SELECT property_info.*, municipality_list.mun_name AS municipality_name FROM property_info JOIN municipality_list ON property_info.property_municipality = municipality_list.mun_ID WHERE property_info.recording_person_id = $user_id ORDER BY property_info.recording_date DESC";
